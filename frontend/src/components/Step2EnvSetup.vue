    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="phase > 0" class="badge success">완료됨</span>
        ...
        <div class="card-content">
          ...
          <p class="description">
            새 simulation 인스턴스를 생성하고, 시뮬레이션 세계 파라미터 템플릿을 불러옵니다
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="phase > 1" class="badge success">완료됨</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        <div class="card-header">
          ...
          <div class="step-status">
            <span v-if="phase > 2" class="badge success">완료됨</span>
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            LLM이 시뮬레이션 요구사항과 현실 시드에 따라, 세계 시간 흐름 속도, 추천 알고리즘, 각 개체의 활동 시간대, 발언 빈도, 이벤트 트리거 등의 파라미터를 지능적으로 설정합니다
          </p>
                  ...
                  <div class="agent-params">
                    <div class="param-group">
                      <div class="param-item">
                        <span class="param-label">게시글/시간</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            내러티브 방향에 따라, 초기 활성화 이벤트와 인기 토픽을 자동 생성하여 시뮬레이션 세계의 초기 상태를 유도합니다
          </p>
          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                ...
                <span class="section-desc">MiroFish가 현실 <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> 시간의 시뮬레이션을 자동 계획하며, 각 라운드는 현실 <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> 분의 시간 흐름을 나타냅니다</span>
              </div>
              ...
              <div v-else class="rounds-content auto" key="auto">
                <div class="auto-info-card">
                  ...
                  <div class="auto-content">
                    ...
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">처음 실행하는 경우, ‘사용자 지정 모드’로 전환하여 시뮬레이션 라운드를 줄이는 것을 강력히 권장합니다. 빠르게 효과를 미리보고 오류 위험을 줄일 수 있습니다 ➝</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="modal-section" v-if="selectedProfile.persona">
            ...
            <div class="persona-dimensions">
              <div class="dimension-card">
                <span class="dim-title">시뮬레이션 전체 경험</span>
                <span class="dim-desc">시뮬레이션에서의 완전한 행동 궤적</span>
              </div>
              <div class="dimension-card">
...
// 설정에서 자동 생성된 라운드 수 계산 (하드코딩된 기본값 사용 안 함)
const autoGeneratedRounds = computed(() => {
  ...
  // 최대 라운드가 40(권장값) 미만이 되지 않도록 하여 슬라이더 범위 이상 방지
...
const handleStartSimulation = () => {
  ...
  if (useCustomRounds.value) {
    // 사용자 지정 라운드, max_rounds 파라미터 전달
    params.maxRounds = customMaxRounds.value
    addLog(`시뮬레이션 시작, 사용자 지정 라운드: ${customMaxRounds.value} 라운드`)
  } else {
    // 사용자가 자동 생성 라운드 유지 선택, max_rounds 파라미터 미전달
...
const loadPreparedData = async () => {
  ...
  // 마지막으로 Profiles 한 번 가져오기
  await fetchProfilesRealtime()
  addLog(`${profiles.value.length}개 Agent 페르소나 로드됨`)
