...
// 초기화 시 query 파라미터에서 직접 maxRounds를 가져와 자식 컴포넌트가 즉시 값을 받을 수 있도록 함
...
const handleNextStep = () => {
  // Step3Simulation 컴포넌트가 보고서 생성과 라우트 이동을 직접 처리
  // 이 메서드는 백업용
...
const loadGraph = async (graphId) => {
  // 시뮬레이션 중일 때 자동 새로고침 시 전체 화면 로딩을 표시하지 않아 깜빡임 방지
