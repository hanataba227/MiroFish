  ...
  <div class="home-container">
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          <div class="tag-row">
            <span class="orange-tag">간결하고 범용적인 군집 지능 엔진</span>
          ...
          <div class="hero-desc">
            <p>
              단 한 단락의 텍스트만으로도, <span class=”highlight-bold”>MiroFish</span>는 그 안의 현실 시드를 기반으로 최대 <span class=”highlight-orange”>백만 Agent</span>로 구성된 병렬 세계를 자동 생성합니다. 신의 시점에서 변수를 주입하여, 복잡한 군집 상호작용 속에서 동적 환경의 <span class=”highlight-code”>”국소 최적해”</span>를 탐색합니다
            </p>
            <p class="slogan-text">
              미래를 Agent 군집에서 시뮬레이션하고, 수많은 시행착오 끝에 최적의 의사결정을 도출하다<span class="blinking-cursor">_</span>
            </p>
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            예측 엔진 대기 중, 비정형 데이터를 업로드하여 시뮬레이션 시퀀스를 초기화할 수 있습니다
          </p>
            ...
            <div class="workflow-list">
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">현실 시드 추출 & 개체/군집 기억 주입 & GraphRAG 구축</div>
                </div>
              </div>
              <div class="workflow-item">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">듀얼 플랫폼 병렬 시뮬레이션 & 예측 요구 자동 분석 & 시계열 기억 동적 업데이트</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">ReportAgent가 풍부한 도구를 활용하여 시뮬레이션 후 환경과 심층 상호작용</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              >
                ...
                <div v-if="files.length === 0" class="upload-placeholder">
                  ...
                  <div class="upload-hint">또는 클릭하여 파일을 찾아보세요</div>
                </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// 자연어로 시뮬레이션 또는 예측 요구사항을 입력하세요 (예: 특정 기관이 처분 철회 공고를 발표하면 어떤 여론 동향이 발생할까요)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
:root {
  ...
  --border: #E5E5E5;
  /*
    Space Grotesk을 주요 제목 폰트로, JetBrains Mono를 코드/태그 폰트로 사용
    index.html에서 해당 Google Fonts를 불러왔는지 확인하세요
  */
