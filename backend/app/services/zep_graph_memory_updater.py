...
Dynamically updates Agent activities from simulations into Zep graphs
"""
...
class AgentActivity:
    ...
    def to_episode_text(self) -> str:
        ...
        Uses natural language format so Zep can extract entities and relations.
...
class ZepGraphMemoryUpdater:
    ...
    Groups by platform and sends in batches of BATCH_SIZE per platform.
    ...
    def __init__(self, graph_id: str, api_key: Optional[str] = None):
        ...
        self._total_items_sent = 0  # Successful activity items sent to Zep
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        action_args contains full context info (e.g., post content, usernames).
    ...
    def _send_batch_activities(self, activities: List[AgentActivity], platform: str):
        """
        Send activities to Zep graph in batch (merged into one text)
