...
class OasisProfileGenerator:
    ...
    2. Generate very detailed personas (including basic info, career experience, personality traits, social media behavior, etc.)
    3. Distinguish between individual entities and abstract group entities
    """
    ...
    def _search_zep_for_entity(self, entity: EntityNode) -> Dict[str, Any]:
        ...
        Zep does not have a built-in hybrid search interface; need to search edges and nodes separately then merge results.
    ...
    def _is_group_entity(self, entity_type: str) -> bool:
        """Check if entity is group/institution type"""
    ...
    def _try_fix_json(self, content: str, entity_name: str, entity_type: str, entity_summary: str = "") -> Dict[str, Any]:
        ...
        # 1. First try fixing truncated case
        content = self._fix_truncated_json(content)
...
- 机构账号发言要符合其身份定位"""
    ...
    def generate_profiles_from_entities(
        ...
        Args:
            ...
            realtime_output_path: Realtime output file path (if provided, write after each generation)
        ...
        # Realtime file write helper function
        ...
        print(f"\n{'='*60}")
        print(f"Starting Agent persona generation - {total} entities, parallel: {parallel_count}")
        print(f"{'='*60}\n")
