...
Endpoint 1: Analyze text content and generate entity and relation type definitions for social simulation
"""
...
# System prompt for ontology generation (functional LLM prompt - do not translate)
...
class OntologyGenerator:
    ...
    def _build_user_message(
        ...
        # Truncate if text exceeds 50K chars (only affects LLM input, not graph building)
