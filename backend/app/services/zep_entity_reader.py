...
class ZepEntityReader:
    ...
    def get_node_edges(self, node_uuid: str) -> List[Dict[str, Any]]:
        """
        Get all related edges for a node (with retry mechanism)
    ...
    def filter_defined_entities(
        ...
        - If a node's Labels contain labels besides "Entity" and "Node", it matches a predefined type, keep it
        ...
        for node in all_nodes:
            ...
            # Filtering logic: Labels must contain labels besides "Entity" and "Node"
