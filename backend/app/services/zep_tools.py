...
class ZepToolsService:
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        Gets all edges from graph, then filters for edges related to specified node
    ...
    def _generate_sub_queries(
        ...
        Decompose complex questions into multiple independently searchable sub-queries
        """
...
返回JSON格式的子问题列表。"""
    ...
    def panorama_search(
        ...
        Get full picture view, including all related content and historical/expired information:
        1. Get all related nodes
        2. Get all edges (including expired/invalid)
        3. Categorize current valid and historical information
        
        This tool is suitable for scenarios requiring understanding of event overview and tracking evolution.
    ...
    def interview_agents(
        ...
        Call real OASIS interview API to interview Agents running in simulation:
        1. Auto-read persona files to understand all simulated Agents
        2. Use LLM to analyze interview requirements, intelligently select most relevant Agents
        3. Use LLM to generate interview questions
        4. Call /api/simulation/interview/batch API for real interviews (dual-platform simultaneous)
        ...
        try:
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                # Strategy 2 (supplementary): Properly paired Chinese quote text
                if not key_quotes:
