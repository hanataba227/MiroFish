...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        try:
            ...
            # Create main log file to avoid process blocking from stdout/stderr pipe buffer filling up
            main_log_path = os.path.join(sim_dir, "simulation.log")
            main_log_file = open(main_log_path, 'w', encoding='utf-8')
            
            # Set subprocess environment variables to ensure UTF-8 encoding on Windows
            # This fixes encoding issues in third-party libraries (e.g., OASIS) when reading files
            env = os.environ.copy()
                        ...
                        try:
                            ...
                            if "event_type" in action_data:
                                ...
                                if event_type == "simulation_end":
                                    ...
                                    # If two platforms were running, both must be completed
    ...
    def _terminate_process(cls, process: subprocess.Popen, simulation_id: str, timeout: int = 10):
        ...
        if IS_WINDOWS:
            ...
            try:
                ...
                # If still not terminated after timeout, force SIGKILL
    ...
    def cleanup_simulation_logs(cls, simulation_id: str) -> Dict[str, Any]:
        """
        Clean up simulation run logs (for force-restarting simulations)
    ...
    def register_cleanup(cls):
        ...
        # In non-debug mode, this env var does not exist, and registration is also needed
    ...
    def check_env_alive(cls, simulation_id: str) -> bool:
        ...
        Returns:
            True if environment is alive, False if it has been closed
        """
        sim_dir = os.path.join(cls.RUN_STATE_DIR, simulation_id)
        if not os.path.exists(sim_dir):
            return False
